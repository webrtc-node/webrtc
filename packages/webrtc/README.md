...
<p align="center">
  ...
  <img alt="WPT" src="https://img.shields.io/badge/WPT-1013%20selected%20subtests-4c1">
...
<p align="center">
  ...
  shipped as a Node-API native addon, and validated with 1013 selected Web
...
Read
[CONTRIBUTING.md](https://github.com/webrtc-node/webrtc/blob/main/CONTRIBUTING.md)
before opening a pull request. Public API changes should update runtime code,
TypeScript declarations, tests, and WPT documentation together.
