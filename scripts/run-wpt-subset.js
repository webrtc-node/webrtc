...
const defaultSpecs = [
  ...
  { file: "webrtc/RTCIceTransport.html", search: "?interop-2026" },
  {
    ...
    include: [
      ...
      'RTCIceTransport should not transition to "checking" until after the answer is set',
  ...
  { file: "webrtc/RTCRtpSender-getCapabilities.html" },
